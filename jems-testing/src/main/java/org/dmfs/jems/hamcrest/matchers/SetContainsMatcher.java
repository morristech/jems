 ...
 * @author Marten Gajda
 */
public final class SetContainsMatcher<T> extends TypeSafeDiagnosingMatcher<Set<T>>
{
    ...
    @SafeVarargs
    public static <T> Matcher<Set<T>> contains(T... expected)
    {
        return contains(new Seq<>(expected));
    }


    public static <T> Matcher<Set<T>> contains(Iterable<T> expected)
    {
