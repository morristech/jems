 ...
 * @author Marten Gajda
 */
public final class SingletonSetTest
{
    @Test
    public void test() throws Exception
    {
        assertThat(new SingletonSet<>("a"), setOf("a"));
        assertThat(new SingletonSet<>("a"), iteratesTo("a"));
        assertThat(new SingletonSet<>("a"), lacks("b", "c", "A"));
    }
